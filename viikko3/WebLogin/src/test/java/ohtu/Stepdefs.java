...
public class Stepdefs {
	...
	@When("a valid username {string} and password {string} and a nonmatching password {string} confirmation are entered")
	public void aValidUsernameAndPasswordAndANonmatchingPasswordConfirmationAreEntered(String username, String password, String confirmation) {
		createWith(username, password, confirmation);
	}
	...
	private void createWith(String username, String password, String confirmation) {
